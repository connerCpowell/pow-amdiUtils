...
from settings import T74_MISSING, MPLX_MISSING
...
class Multiplexer:
    ...
    def channel(self, channel):  # values 0-1 indicate the channel, anything else (eg -1) turns off all channels
        if self.mplx_present:
            ...
            msg = 'Multiplexer frontend for the laser temperature sensors is missing'
            logging.warn(msg)
            pass
...
class TC74:
    ...
    def __init__(self, bus, devaddr):
        ...
        self.tc74_present    = 0        # flag to denote of the T74 was even found
        try:
    ...
    def read_temp(self):
        if self.tc74_present:
            ...
            return T74_MISSING  # impossible value to denote that the t74 wasn't available
...
if __name__ == '__main__':
    ...
    def paint_screen():
        ...
        screen.addstr(6, 0, 'Special note: even at power level 0 the laser WILL lase, you must turn it off')

        screen.addstr(8, 0, 'TICK')

        screen.addstr(21, 0, 'Repaint screen if text gets messed up - <crtl>-l')
        ...
        while True:
            ...
            if change:
                ...
                if laser == 2:
                    ...
                    if temp_hw_available:
                        mplx.channel(1)  # Select laser1 temperature sensor
                        temp2 = tc74_sensor.read_temp()
                    else:
                        temp2 = -999
