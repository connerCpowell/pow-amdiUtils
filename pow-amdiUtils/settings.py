...
RPI_PRESENT            = 1  # This is for testing when not on an RPi. You
...
ORANGE_LED             = 20
if RPI_PRESENT:
    ORANGE_LED_ON          = GPIO.HIGH
    ORANGE_LED_OFF         = GPIO.LOW
    WHITE_LED_ON           = GPIO.HIGH
    WHITE_LED_OFF          = GPIO.LOW
    CAMERA_ON              = GPIO.HIGH
    CAMERA_OFF             = GPIO.LOW
...
# Used in Motor.py
HOME_ACCEL             = 40    # RPM / second (used in .home())
