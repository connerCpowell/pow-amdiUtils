...
class TrinamicMotor:
    ...
    def position_abs(self, ticks):  # ticks
        ...
        self.format_command(header_MVP_ABS, int(-ticks))
        self.send()
        self.receive()
        return self
    ...
    def position_rel(self, ticks):  # ticks
        ...
        self.format_command(header_MVP_REL, int(-ticks))
        self.send()
        self.receive()
        return self
    ...
    def velocity_ramp_generator(self):
    ...
    def set_position_p(self, pos_P):
        header_set_position_P = '0105E600'  # header
    ...
    def set_velocity_p(self, velo_P):
        header_set_velocity_P = '0105EA00'  # header
    ...
    def set_velocity_i(self, velo_I):
        header_set_velocity_I = '0105EB00'  # header
    ...
    def set_torque_p(self, torque_P):
        header_set_torque_P = '0105AC00'  # header
    ...
    def set_torque_i(self, torque_I):
        header_set_torque_I = '0105AD00'  # header
    ...
    def get_torque_i(self):
        header_get_torque_I = '0106AD00'  # GAP 17=3
    ...
    def encoder_clear_set_null(self, zeorOrOne):
        header_encoder_clear_set_null = '0105A300'  # SAP 163
        self.format_command(header_encoder_clear_set_null, zeorOrOne)
        self.send()
        self.receive()
        return self
    ...
    def set_encoder_direction(self):
        ...
        self.format_command(header_set_encoder_direction, 1)  # high
        self.send()
        self.receive()
        return self
    
    def get_encoder_direction(self):
        header_get_encoder_direction = '0106FB00'  # GAP 251
        self.format_command(header_get_encoder_direction, 0)
        self.send()
        self.receive()
        if self.rcv_checksum_passed == True:
            if self.rcv_instruction == GAP:
    ...
    def get_encoder_steps(self):
        header_get_encoder_steps = '0106FA00' # GPA 250
        self.format_command(header_get_encoder_steps, 0)
        self.send()
        self.receive()
        if self.rcv_checksum_passed == True:
            if self.rcv_instruction == GAP:
    ...
    def wait_for_event(self, condition, timeout=0):  # NOT FOR DIRECT!!
        if condition == 1:
    ...
    def get_actual_encoder_angle(self):     # in degrees
    ...
    def get_actual_encoder_angle_modulo(self):   # in degrees
        header_get_actual_encoder_angle = '01060100'
        self.format_command(header_get_actual_encoder_angle, 0)
        self.send()
        self.receive()  # 9 bytes
    ...
    def get_actual_encoder_count(self):
        header_get_actual_encoder_angle = '01060100'
        self.format_command(header_get_actual_encoder_angle, 0)
        self.send()
        self.receive()  # 9 bytes
    ...
    def get_actual_encoder_count_modulo(self):
        header_get_actual_encoder_angle = '01060100'
        self.format_command(header_get_actual_encoder_angle, 0)
        self.send()
        self.receive()  # 9 bytes
    ...
    #def get_encoder_set_null(self):                                            # DUPLICATE DEFINITION
    #    header_get_encoder_set_null = '0106A100'
    #    self.format_command(header_get_encoder_set_null, 0)
    #    self.send()
    #    self.receive()
    #    if self.rcv_checksum_passed == True:
    ...
    #def BLDC_reinitialization(self):                                           # lets not use this at all anymore
