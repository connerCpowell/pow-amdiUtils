...
from settings import LOGGING_FILE, SI_COUNT, CALIBRATION_FILE, POSI_FILE
...
class E20:
    ...
    def laser_sweep(self,
        ...
        if pattern == 'C':
            ...
            logging.info('POSI: Current position b4 LV1 C: %d' % posi2)
            ...
            logging.info('POSI: position af LV1 C: %d' % posi)
    ...
    def laser2_sweep(self,
        ...
        if pattern == 'C':
            ...
            sleep(SETTLE)  # let trinamic board positioning settle
            posi2 = self.motor.get_actual_encoder_count()
            logging.info('POSI: Current position b4 LV2 C: %d' % posi2)
            ...
            posi = self.motor.get_actual_encoder_count()
            logging.info('POSI: position af LV2 C: %d' % posi)
